...
enum ImGuiNavMoveFlags_ {
    ...
    ImGuiNavMoveFlags_AlsoScoreVisibleSet = 1 << 5 // Store alternate result in NavMoveResultLocalVisibleSet that
...
struct IMGUI_API ImGuiWindowTempData {
    ...
    ImVec1
        ...
        // use cases like Tree->Column->Tree. Need revamp columns
        // API.
...
enum ImGuiTabBarFlagsPrivate_ {
    ...
    ImGuiTabBarFlags_DockNodeIsDockSpace = 1 << 21, // [Docking: Unused in Master Branch] Part of an explicit
    // dockspace node node
    ImGuiTabBarFlags_IsFocused = 1 << 22,
    ImGuiTabBarFlags_SaveSettings = 1
        << 23 // FIXME: Settings are handled by the docking system, this only

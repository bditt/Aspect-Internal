...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Help")) {
        ...
        ImGui::BulletText(
            "Please see the ShowDemoWindow() code in imgui_demo.cpp. "
            "<- you are here!");
    ...
    if (ImGui::CollapsingHeader("Configuration")) {
        ...
        if (ImGui::TreeNode("Configuration##2")) {
            ...
            ImGui::SameLine();
            ShowHelpMarker(
                "Instruct navigation to move the mouse cursor. See "
        ...
        if (ImGui::TreeNode("Capture/Logging")) {
            ImGui::TextWrapped(
                "The logging API redirects all text output so you can "
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Basic")) {
        ...
        if (ImGui::ArrowButton("##left", ImGuiDirLeft)) {
            counter--;
        }
    ...
    if (ImGui::TreeNode("Plots Widgets")) {
        ...
        while (
            refresh_time < ImGui::GetTime()) // Create dummy data at fixed 60 hz rate for the demo
        {
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Horizontal Scrolling")) {
        ShowHelpMarker(
            ...
            "by calling SetNextWindowContentWidth() before Begin().");
        static int lines = 7;
...
static void ShowDemoWindowColumns()
{
  ...
  */
    ...
    ImGui::SameLine();
    ShowHelpMarker(
        "NB: Tree node must be poped before ending the cell. There's "
        "no storage of state per-cell.");
    if (node_open) {
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None)) {
        if (ImGui::BeginTabItem("Sizes")) {
            ...
            ImGui::SameLine();
            ShowHelpMarker(
                "Adjust if you cannot see the edges of your screen (e.g. "
                                ...
                                for (int n = 0; n < 256; n++) {
                                    ...
                                    if (glyph)
                                        font->RenderChar(
                                            ...
                                            (ImWchar)(
                                                base + n)); // We use ImFont::RenderChar as a shortcut
        ...
        if (ImGui::BeginTabItem("Rendering")) {
            ...
            ImGui::SameLine();
            ShowHelpMarker(
                "When disabling anti-aliasing lines, you'll probably want "
...
struct ExampleAppConsole {
    ...
    static int TextEditCallbackStub(
        ImGuiInputTextCallbackData* data) // In C++11 you are better off using lambdas
...
static void ShowExampleAppSimpleOverlay(bool* p_open)
{
    ...
    if (ImGui::Begin("Example: Simple overlay", p_open,
            (corner != -1 ? ImGuiWindowFlags_NoMove : 0) | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoFocusOnAppearing | ImGuiWindowFlags_NoNav)) {
        ImGui::Text(
            "Simple overlay\n"
